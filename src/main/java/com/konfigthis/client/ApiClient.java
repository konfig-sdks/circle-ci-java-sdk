...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://circleci.com/api/v2";
    ...
    public ApiClient(OkHttpClient client, Configuration configuration) {
        ...
        authentications.put("api_key_header", new ApiKeyAuth("header", "Circle-Token"));
        authentications.put("api_key_query", new ApiKeyAuth("query", "circle-token"));
        ...
        if (configuration != null) {
            if (configuration.apiKeyHeader != null) {
                this.setApiKeyHeader(configuration.apiKeyHeader);
            }
            if (configuration.apiKeyQuery != null) {
                this.setApiKeyQuery(configuration.apiKeyQuery);
            }
    ...
    public String getApiKeyHeader() {
        return ((ApiKeyAuth) this.getAuthentication("api_key_header")).getApiKey();
    }

    public void setApiKeyHeader(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("api_key_header")).setApiKey(apiKey);
    }

    public void setApiKeyHeaderPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("api_key_header")).setApiKeyPrefix(prefix);
    }
    public String getApiKeyQuery() {
        return ((ApiKeyAuth) this.getAuthentication("api_key_query")).getApiKey();
    }

    public void setApiKeyQuery(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("api_key_query")).setApiKey(apiKey);
    }

    public void setApiKeyQueryPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("api_key_query")).setApiKeyPrefix(prefix);
    }
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://circleci.com/api/v2)
