 ...
 * An artifact
 */
@ApiModel(description = "An artifact")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Artifact {
  ...
  **/
  ...
  public Artifact nodeIndex(Long nodeIndex) {
    if (nodeIndex != null && nodeIndex < 0) {
      throw new IllegalArgumentException("Invalid value for nodeIndex. Must be greater than or equal to 0.");
    }
  ...
  **/
   ...
   * @return the Artifact instance itself
   */
  public Artifact putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.path, artifact.path) &&
        ...
        Objects.equals(this.additionalProperties, artifact.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(path, nodeIndex, url, additionalProperties);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("node_index");
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Artifact>() {
           ...
           public Artifact read(JsonReader in) throws IOException {
             ...
             Artifact instance = thisAdapter.fromJsonTree(jsonObj);
