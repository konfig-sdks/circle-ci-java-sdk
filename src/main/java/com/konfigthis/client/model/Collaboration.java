...
public class Collaboration {
  ...
  public static final String SERIALIZED_NAME_VCS_TYPE = "vcs-type";
  ...
  public Collaboration id(UUID id) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The UUID of the organization")
  ...
  **/
  ...
  public Collaboration slug(String slug) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The slug of the organization")
  ...
  static {
    ...
    openapiRequiredFields.add("vcs-type");
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (!jsonObj.get("vcs-type").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `vcs-type` to be a primitive type in the JSON string but got `%s`", jsonObj.get("vcs-type").toString()));
      }
