 ...
 */
@ApiModel(description = "Timetable that specifies when a schedule triggers.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ScheduleUpdateScheduleRequestTimetable {
  ...
  private List<Integer> hoursOfDay = null;
 ...
 public enum MonthsEnum {
  ...
  public ScheduleUpdateScheduleRequestTimetable() {
  }

  public ScheduleUpdateScheduleRequestTimetable perHour(Integer perHour) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Number of times a schedule triggers per hour, value must be between 1 and 60")
  ...
  public ScheduleUpdateScheduleRequestTimetable hoursOfDay(List<Integer> hoursOfDay) {
  ...
  public ScheduleUpdateScheduleRequestTimetable addHoursOfDayItem(Integer hoursOfDayItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Hours in a day in which the schedule triggers.")
  ...
  public ScheduleUpdateScheduleRequestTimetable daysOfWeek(List<DaysOfWeekEnum> daysOfWeek) {
  ...
  public ScheduleUpdateScheduleRequestTimetable addDaysOfWeekItem(DaysOfWeekEnum daysOfWeekItem) {
  ...
  **/
  ...
  public ScheduleUpdateScheduleRequestTimetable daysOfMonth(List<Integer> daysOfMonth) {
  ...
  public ScheduleUpdateScheduleRequestTimetable addDaysOfMonthItem(Integer daysOfMonthItem) {
  ...
  **/
  ...
  public ScheduleUpdateScheduleRequestTimetable months(List<MonthsEnum> months) {
  ...
  public ScheduleUpdateScheduleRequestTimetable addMonthsItem(MonthsEnum monthsItem) {
    if (this.months == null) {
  ...
  **/
   ...
   * @return the ScheduleUpdateScheduleRequestTimetable instance itself
   */
  public ScheduleUpdateScheduleRequestTimetable putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ScheduleUpdateScheduleRequestTimetable scheduleUpdateScheduleRequestTimetable = (ScheduleUpdateScheduleRequestTimetable) o;
    return Objects.equals(this.perHour, scheduleUpdateScheduleRequestTimetable.perHour) &&
        Objects.equals(this.hoursOfDay, scheduleUpdateScheduleRequestTimetable.hoursOfDay) &&
        Objects.equals(this.daysOfWeek, scheduleUpdateScheduleRequestTimetable.daysOfWeek) &&
        Objects.equals(this.daysOfMonth, scheduleUpdateScheduleRequestTimetable.daysOfMonth) &&
        Objects.equals(this.months, scheduleUpdateScheduleRequestTimetable.months)&&
        Objects.equals(this.additionalProperties, scheduleUpdateScheduleRequestTimetable.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ScheduleUpdateScheduleRequestTimetable {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ScheduleUpdateScheduleRequestTimetable
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ScheduleUpdateScheduleRequestTimetable.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ScheduleUpdateScheduleRequestTimetable is not found in the empty JSON string", ScheduleUpdateScheduleRequestTimetable.openapiRequiredFields.toString()));
        }
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("hours-of-day") != null && !jsonObj.get("hours-of-day").isJsonArray()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ScheduleUpdateScheduleRequestTimetable.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ScheduleUpdateScheduleRequestTimetable' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ScheduleUpdateScheduleRequestTimetable> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ScheduleUpdateScheduleRequestTimetable.class));

       return (TypeAdapter<T>) new TypeAdapter<ScheduleUpdateScheduleRequestTimetable>() {
           @Override
           public void write(JsonWriter out, ScheduleUpdateScheduleRequestTimetable value) throws IOException {
           ...
           @Override
           public ScheduleUpdateScheduleRequestTimetable read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ScheduleUpdateScheduleRequestTimetable instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ScheduleUpdateScheduleRequestTimetable given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ScheduleUpdateScheduleRequestTimetable
  * @throws IOException if the JSON string is invalid with respect to ScheduleUpdateScheduleRequestTimetable
  */
  public static ScheduleUpdateScheduleRequestTimetable fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ScheduleUpdateScheduleRequestTimetable.class);
  }

 /**
  * Convert an instance of ScheduleUpdateScheduleRequestTimetable to an JSON string
  *
  * @return JSON string
  */
