...
import com.konfigthis.client.model.Pipeline1Vcs;
...
public class Pipeline1 {
 ...
 public enum StateEnum {
  ...
  private Pipeline1Vcs vcs;

  public Pipeline1() {
  }

  public Pipeline1 id(UUID id) {
  ...
  **/
  ...
  public Pipeline1 errors(List<PipelineErrorsInner> errors) {
  ...
  public Pipeline1 addErrorsItem(PipelineErrorsInner errorsItem) {
  ...
  **/
  ...
  public Pipeline1 projectSlug(String projectSlug) {
  ...
  **/
  ...
  public Pipeline1 updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public Pipeline1 number(Long number) {
  ...
  **/
  ...
  public Pipeline1 triggerParameters(Map<String, Object> triggerParameters) {
  ...
  public Pipeline1 putTriggerParametersItem(String key, Object triggerParametersItem) {
  ...
  **/
  ...
  public Pipeline1 state(StateEnum state) {
  ...
  **/
  ...
  public Pipeline1 createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public Pipeline1 trigger(PipelineTrigger trigger) {
  ...
  **/
  ...
  public Pipeline1 vcs(Pipeline1Vcs vcs) {
  ...
  **/
  ...
  public Pipeline1Vcs getVcs() {
    return vcs;
  }


  public void setVcs(Pipeline1Vcs vcs) {
   ...
   * @return the Pipeline1 instance itself
   */
  public Pipeline1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Pipeline1 pipeline1 = (Pipeline1) o;
    return Objects.equals(this.id, pipeline1.id) &&
        Objects.equals(this.errors, pipeline1.errors) &&
        Objects.equals(this.projectSlug, pipeline1.projectSlug) &&
        Objects.equals(this.updatedAt, pipeline1.updatedAt) &&
        Objects.equals(this.number, pipeline1.number) &&
        Objects.equals(this.triggerParameters, pipeline1.triggerParameters) &&
        Objects.equals(this.state, pipeline1.state) &&
        Objects.equals(this.createdAt, pipeline1.createdAt) &&
        Objects.equals(this.trigger, pipeline1.trigger) &&
        Objects.equals(this.vcs, pipeline1.vcs)&&
        Objects.equals(this.additionalProperties, pipeline1.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Pipeline1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Pipeline1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Pipeline1 is not found in the empty JSON string", Pipeline1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Pipeline1.openapiRequiredFields) {
      ...
      if (jsonObj.get("vcs") != null && !jsonObj.get("vcs").isJsonNull()) {
        Pipeline1Vcs.validateJsonObject(jsonObj.getAsJsonObject("vcs"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Pipeline1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Pipeline1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Pipeline1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Pipeline1.class));

       return (TypeAdapter<T>) new TypeAdapter<Pipeline1>() {
           @Override
           public void write(JsonWriter out, Pipeline1 value) throws IOException {
           ...
           @Override
           public Pipeline1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Pipeline1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Pipeline1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Pipeline1
  * @throws IOException if the JSON string is invalid with respect to Pipeline1
  */
  public static Pipeline1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Pipeline1.class);
  }

 /**
  * Convert an instance of Pipeline1 to an JSON string
  *
  * @return JSON string
  */
