 ...
 */
@ApiModel(description = "The attribution actor who will run the scheduled pipeline.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class UserProperty {
  ...
  public UserProperty id(UUID id) {
  ...
  **/
  ...
  public UserProperty login(String login) {
  ...
  **/
  ...
  public UserProperty name(String name) {
  ...
  **/
   ...
   * @return the UserProperty instance itself
   */
  public UserProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, userProperty.id) &&
        Objects.equals(this.login, userProperty.login) &&
        Objects.equals(this.name, userProperty.name)&&
        Objects.equals(this.additionalProperties, userProperty.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to UserProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UserProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UserProperty>() {
           ...
           public UserProperty read(JsonReader in) throws IOException {
             ...
             UserProperty instance = thisAdapter.fromJsonTree(jsonObj);
