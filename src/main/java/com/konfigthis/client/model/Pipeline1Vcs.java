...
public class Pipeline1Vcs {
  ...
  public Pipeline1Vcs providerName(String providerName) {
  ...
  **/
  ...
  public Pipeline1Vcs targetRepositoryUrl(String targetRepositoryUrl) {
  ...
  **/
  ...
  public Pipeline1Vcs branch(String branch) {
  ...
  **/
  ...
  public Pipeline1Vcs reviewId(String reviewId) {
  ...
  **/
  ...
  public Pipeline1Vcs reviewUrl(String reviewUrl) {
  ...
  **/
  ...
  public Pipeline1Vcs revision(String revision) {
  ...
  **/
  ...
  public Pipeline1Vcs tag(String tag) {
  ...
  **/
  ...
  public Pipeline1Vcs commit(PipelineVcsCommit commit) {
  ...
  **/
  ...
  public Pipeline1Vcs originRepositoryUrl(String originRepositoryUrl) {
  ...
  **/
   ...
   * @return the Pipeline1Vcs instance itself
   */
  public Pipeline1Vcs putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Pipeline1Vcs pipeline1Vcs = (Pipeline1Vcs) o;
    return Objects.equals(this.providerName, pipeline1Vcs.providerName) &&
        Objects.equals(this.targetRepositoryUrl, pipeline1Vcs.targetRepositoryUrl) &&
        Objects.equals(this.branch, pipeline1Vcs.branch) &&
        Objects.equals(this.reviewId, pipeline1Vcs.reviewId) &&
        Objects.equals(this.reviewUrl, pipeline1Vcs.reviewUrl) &&
        Objects.equals(this.revision, pipeline1Vcs.revision) &&
        Objects.equals(this.tag, pipeline1Vcs.tag) &&
        Objects.equals(this.commit, pipeline1Vcs.commit) &&
        Objects.equals(this.originRepositoryUrl, pipeline1Vcs.originRepositoryUrl)&&
        Objects.equals(this.additionalProperties, pipeline1Vcs.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Pipeline1Vcs
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Pipeline1Vcs.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Pipeline1Vcs is not found in the empty JSON string", Pipeline1Vcs.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Pipeline1Vcs.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Pipeline1Vcs.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Pipeline1Vcs' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Pipeline1Vcs> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Pipeline1Vcs.class));

       return (TypeAdapter<T>) new TypeAdapter<Pipeline1Vcs>() {
           @Override
           public void write(JsonWriter out, Pipeline1Vcs value) throws IOException {
           ...
           @Override
           public Pipeline1Vcs read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Pipeline1Vcs instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Pipeline1Vcs given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Pipeline1Vcs
  * @throws IOException if the JSON string is invalid with respect to Pipeline1Vcs
  */
  public static Pipeline1Vcs fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Pipeline1Vcs.class);
  }

 /**
  * Convert an instance of Pipeline1Vcs to an JSON string
  *
  * @return JSON string
  */
