...
public class Pipeline2Vcs {
  ...
  public Pipeline2Vcs providerName(String providerName) {
  ...
  **/
  ...
  public Pipeline2Vcs targetRepositoryUrl(String targetRepositoryUrl) {
  ...
  **/
  ...
  public Pipeline2Vcs branch(String branch) {
  ...
  **/
  ...
  public Pipeline2Vcs reviewId(String reviewId) {
  ...
  **/
  ...
  public Pipeline2Vcs reviewUrl(String reviewUrl) {
  ...
  **/
  ...
  public Pipeline2Vcs revision(String revision) {
  ...
  **/
  ...
  public Pipeline2Vcs tag(String tag) {
  ...
  **/
  ...
  public Pipeline2Vcs commit(PipelineVcsCommit commit) {
  ...
  **/
  ...
  public Pipeline2Vcs originRepositoryUrl(String originRepositoryUrl) {
  ...
  **/
   ...
   * @return the Pipeline2Vcs instance itself
   */
  public Pipeline2Vcs putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Pipeline2Vcs pipeline2Vcs = (Pipeline2Vcs) o;
    return Objects.equals(this.providerName, pipeline2Vcs.providerName) &&
        Objects.equals(this.targetRepositoryUrl, pipeline2Vcs.targetRepositoryUrl) &&
        Objects.equals(this.branch, pipeline2Vcs.branch) &&
        Objects.equals(this.reviewId, pipeline2Vcs.reviewId) &&
        Objects.equals(this.reviewUrl, pipeline2Vcs.reviewUrl) &&
        Objects.equals(this.revision, pipeline2Vcs.revision) &&
        Objects.equals(this.tag, pipeline2Vcs.tag) &&
        Objects.equals(this.commit, pipeline2Vcs.commit) &&
        Objects.equals(this.originRepositoryUrl, pipeline2Vcs.originRepositoryUrl)&&
        Objects.equals(this.additionalProperties, pipeline2Vcs.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Pipeline2Vcs
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Pipeline2Vcs.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Pipeline2Vcs is not found in the empty JSON string", Pipeline2Vcs.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Pipeline2Vcs.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Pipeline2Vcs.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Pipeline2Vcs' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Pipeline2Vcs> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Pipeline2Vcs.class));

       return (TypeAdapter<T>) new TypeAdapter<Pipeline2Vcs>() {
           @Override
           public void write(JsonWriter out, Pipeline2Vcs value) throws IOException {
           ...
           @Override
           public Pipeline2Vcs read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Pipeline2Vcs instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Pipeline2Vcs given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Pipeline2Vcs
  * @throws IOException if the JSON string is invalid with respect to Pipeline2Vcs
  */
  public static Pipeline2Vcs fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Pipeline2Vcs.class);
  }

 /**
  * Convert an instance of Pipeline2Vcs to an JSON string
  *
  * @return JSON string
  */
