...
import com.konfigthis.client.model.Pipeline2Vcs;
...
public class Pipeline2 {
 ...
 public enum StateEnum {
  ...
  private Pipeline2Vcs vcs;

  public Pipeline2() {
  }

  public Pipeline2 id(UUID id) {
  ...
  **/
  ...
  public Pipeline2 errors(List<PipelineErrorsInner> errors) {
  ...
  public Pipeline2 addErrorsItem(PipelineErrorsInner errorsItem) {
  ...
  **/
  ...
  public Pipeline2 projectSlug(String projectSlug) {
  ...
  **/
  ...
  public Pipeline2 updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public Pipeline2 number(Long number) {
  ...
  **/
  ...
  public Pipeline2 triggerParameters(Map<String, Object> triggerParameters) {
  ...
  public Pipeline2 putTriggerParametersItem(String key, Object triggerParametersItem) {
  ...
  **/
  ...
  public Pipeline2 state(StateEnum state) {
  ...
  **/
  ...
  public Pipeline2 createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public Pipeline2 trigger(PipelineTrigger trigger) {
  ...
  **/
  ...
  public Pipeline2 vcs(Pipeline2Vcs vcs) {
  ...
  **/
  ...
  public Pipeline2Vcs getVcs() {
    return vcs;
  }


  public void setVcs(Pipeline2Vcs vcs) {
   ...
   * @return the Pipeline2 instance itself
   */
  public Pipeline2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Pipeline2 pipeline2 = (Pipeline2) o;
    return Objects.equals(this.id, pipeline2.id) &&
        Objects.equals(this.errors, pipeline2.errors) &&
        Objects.equals(this.projectSlug, pipeline2.projectSlug) &&
        Objects.equals(this.updatedAt, pipeline2.updatedAt) &&
        Objects.equals(this.number, pipeline2.number) &&
        Objects.equals(this.triggerParameters, pipeline2.triggerParameters) &&
        Objects.equals(this.state, pipeline2.state) &&
        Objects.equals(this.createdAt, pipeline2.createdAt) &&
        Objects.equals(this.trigger, pipeline2.trigger) &&
        Objects.equals(this.vcs, pipeline2.vcs)&&
        Objects.equals(this.additionalProperties, pipeline2.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Pipeline2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Pipeline2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Pipeline2 is not found in the empty JSON string", Pipeline2.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Pipeline2.openapiRequiredFields) {
      ...
      if (jsonObj.get("vcs") != null && !jsonObj.get("vcs").isJsonNull()) {
        Pipeline2Vcs.validateJsonObject(jsonObj.getAsJsonObject("vcs"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Pipeline2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Pipeline2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Pipeline2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Pipeline2.class));

       return (TypeAdapter<T>) new TypeAdapter<Pipeline2>() {
           @Override
           public void write(JsonWriter out, Pipeline2 value) throws IOException {
           ...
           @Override
           public Pipeline2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Pipeline2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Pipeline2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Pipeline2
  * @throws IOException if the JSON string is invalid with respect to Pipeline2
  */
  public static Pipeline2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Pipeline2.class);
  }

 /**
  * Convert an instance of Pipeline2 to an JSON string
  *
  * @return JSON string
  */
