...
public class PipelineGetByIdResponseVcs {
  ...
  public PipelineGetByIdResponseVcs() {
  }

  public PipelineGetByIdResponseVcs providerName(String providerName) {
  ...
  **/
  ...
  public PipelineGetByIdResponseVcs targetRepositoryUrl(String targetRepositoryUrl) {
  ...
  **/
  ...
  public PipelineGetByIdResponseVcs branch(String branch) {
  ...
  **/
  ...
  public PipelineGetByIdResponseVcs reviewId(String reviewId) {
  ...
  **/
  ...
  public PipelineGetByIdResponseVcs reviewUrl(String reviewUrl) {
  ...
  **/
  ...
  public PipelineGetByIdResponseVcs revision(String revision) {
  ...
  **/
  ...
  public PipelineGetByIdResponseVcs tag(String tag) {
  ...
  **/
  ...
  public PipelineGetByIdResponseVcs commit(PipelineVcsCommit commit) {
  ...
  **/
  ...
  public PipelineGetByIdResponseVcs originRepositoryUrl(String originRepositoryUrl) {
  ...
  **/
   ...
   * @return the PipelineGetByIdResponseVcs instance itself
   */
  public PipelineGetByIdResponseVcs putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PipelineGetByIdResponseVcs pipelineGetByIdResponseVcs = (PipelineGetByIdResponseVcs) o;
    return Objects.equals(this.providerName, pipelineGetByIdResponseVcs.providerName) &&
        Objects.equals(this.targetRepositoryUrl, pipelineGetByIdResponseVcs.targetRepositoryUrl) &&
        Objects.equals(this.branch, pipelineGetByIdResponseVcs.branch) &&
        Objects.equals(this.reviewId, pipelineGetByIdResponseVcs.reviewId) &&
        Objects.equals(this.reviewUrl, pipelineGetByIdResponseVcs.reviewUrl) &&
        Objects.equals(this.revision, pipelineGetByIdResponseVcs.revision) &&
        Objects.equals(this.tag, pipelineGetByIdResponseVcs.tag) &&
        Objects.equals(this.commit, pipelineGetByIdResponseVcs.commit) &&
        Objects.equals(this.originRepositoryUrl, pipelineGetByIdResponseVcs.originRepositoryUrl)&&
        Objects.equals(this.additionalProperties, pipelineGetByIdResponseVcs.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PipelineGetByIdResponseVcs {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PipelineGetByIdResponseVcs
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PipelineGetByIdResponseVcs.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PipelineGetByIdResponseVcs is not found in the empty JSON string", PipelineGetByIdResponseVcs.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PipelineGetByIdResponseVcs.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PipelineGetByIdResponseVcs.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PipelineGetByIdResponseVcs' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PipelineGetByIdResponseVcs> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PipelineGetByIdResponseVcs.class));

       return (TypeAdapter<T>) new TypeAdapter<PipelineGetByIdResponseVcs>() {
           @Override
           public void write(JsonWriter out, PipelineGetByIdResponseVcs value) throws IOException {
           ...
           @Override
           public PipelineGetByIdResponseVcs read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PipelineGetByIdResponseVcs instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PipelineGetByIdResponseVcs given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PipelineGetByIdResponseVcs
  * @throws IOException if the JSON string is invalid with respect to PipelineGetByIdResponseVcs
  */
  public static PipelineGetByIdResponseVcs fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PipelineGetByIdResponseVcs.class);
  }

 /**
  * Convert an instance of PipelineGetByIdResponseVcs to an JSON string
  *
  * @return JSON string
  */
